...
#We can have as many @given @when @then as necessary for all Strings.
#Every function in called the same. Why? 
#Every function REQUIRES context as an argument if any variable generated by another step inside the Feature is required.
